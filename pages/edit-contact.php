...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) {
        ...
        // Simpan input untuk ditampilkan kembali
        $contact = [
            'nama' => $nama,
            'email' => $email,
            'telepon' => $telepon,
...
<div class="dashboard-container">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem;">
        <div>
            <h1 style="font-size: 2rem; font-weight: 700; color: var(--primary-dark);">Edit Kontak</h1>
            <p style="color: var(--gray-500); margin-top: 0.5rem;">Perbarui informasi kontak</p>
        </div>
        ...
        <form method="POST" action="" style="max-width: 600px;">
            <div class="form-group">
                ...
                <input type="text" name="nama" class="form-input" placeholder="Contoh: John Doe" 
                       value="<?php echo $contact['nama']; ?>" required>
            ...
            <div class="form-group">
                ...
                <input type="tel" name="telepon" class="form-input" placeholder="08123456789" 
                       value="<?php echo $contact['telepon']; ?>" required>
            ...
            <div class="form-group">
                ...
                <select name="kategori" class="form-input" required>
                    ...
                    <option value="Pribadi" <?php echo $contact['kategori'] === 'Pribadi' ? 'selected' : ''; ?>>Pribadi</option>
                    <option value="Kerja" <?php echo $contact['kategori'] === 'Kerja' ? 'selected' : ''; ?>>Kerja</option>
                    <option value="Keluarga" <?php echo $contact['kategori'] === 'Keluarga' ? 'selected' : ''; ?>>Keluarga</option>
                    <option value="Lainnya" <?php echo $contact['kategori'] === 'Lainnya' ? 'selected' : ''; ?>>Lainnya</option>
                </select>
            </div>
